...
class PopularAdapter : RecyclerView.Adapter<PopularAdapter.StoryViewHolder>() {
    ...
    inner class StoryViewHolder(private val binding: ListItemPopularBatikSmallCardBinding) :
        ...
        fun bind(storyItem: ListStoryItem) {
            ...
            binding.apply {
                Glide.with(itemView)
                    ...
                    .centerCrop()
                    .into(ivContentImage)
                tvBatikName.text = storyItem.name
                tvBatikLocation.text = storyItem.createdAt
                tvBatikDescription.text = storyItem.description
            }
        }
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StoryViewHolder {
        val view = ListItemPopularBatikSmallCardBinding.inflate(
